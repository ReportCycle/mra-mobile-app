...
class CopyrightPolicyPage extends StatefulWidget {
  const CopyrightPolicyPage({super.key});

  @override
  _CopyrightPolicyPageState createState() => _CopyrightPolicyPageState();
}

class _CopyrightPolicyPageState extends State<CopyrightPolicyPage> {
